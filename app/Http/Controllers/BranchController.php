...
class BranchController extends Controller
{
                ...
                return '
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <form action="' . route('branches.destroy', $hashId) . '" method="POST" style="display:inline;" onsubmit="return confirm(\'Apakah anda yakin ingin menghapus data cabang ini?\')">
    ...
    public function update(Request $request, $hash)
    {
        ...
        return redirect()->route('branches.index')->with('success', 'Data berhasil di update');
    }
    ...
    public function destroy($hash)
    {
        ...
        return redirect()->route('branches.index')->with('success', 'Data berhasil di hapus');
    }
}
                ...
                ->addColumn('action', function ($row) {
                    ...
                    if (in_array(auth()->user()->role, ['admin', 'operator'])) {
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="' . route('consignees.show', $hashId)  . '" class="dropdown-item">
                                ...
                                <a href="' . route('consignees.edit', $hashId) . '" class="dropdown-item">
                        ...
                        $actionBtn = '
                        <a href="' . route('consignees.show', $hashId) . '" class="btn btn-success">
                            Lihat

                ...
                ->addColumn('action', function($row){
                    ...
                    $btn = '<div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a class="dropdown-item" href="' . url('/clients/' . $encodedId . '/edit') . '">
                                    ...
                                    <form action="' . route('clients.destroy', $encodedId) . '" method="POST" onsubmit="return confirm(\'Apakah anda yakin ingin menghapus client ini?\')" style="display:inline;">
                                        '.csrf_field().'
                                        '.method_field("DELETE").'

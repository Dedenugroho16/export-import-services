        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($commodities)
                ->addColumn('action', function ($row) {
                    ...
                    // If the user is not admin or operator, show only the "Lihat" button
                    if (!in_array($userRole, ['admin', 'operator'])) {
                        return '
                        <a href="' . route('commodities.show', $hashId) . '" class="btn btn-success">
                            Lihat
                    ...
                    // For admin and operator, show the dropdown menu
                    $actionBtn = '
                    <div class="dropdown">

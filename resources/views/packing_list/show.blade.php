            ...
            <div class="mb-4 mt-4 d-flex justify-content-between">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="{{ route('packing-list.exportPdf', ['id' => $hashedId]) }}" target="_blank">
                                Ekspor PDF
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('packing-list.downloadPdf', ['id' => $hashedId]) }}">
                                Download PDF
                            </a>
                        </li>
                    </ul>

                            ...
                            <div>
                                <table class="table-sm mb-6" style="font-size: 15px">
                                    ...
                                    <tr>
                                        <td>COMPANY NAME</td>
                                        <td>:</td>
                                        <td style="font-weight: bold">{{ $paymentDetail->client && $paymentDetail->client->clientCompany 
                                            ? $paymentDetail->client->clientCompany->company_name : '-' }}</td>
                                    </tr>
                                </table>
                                <div>
                                    <div>
                                        <table class="table-bordered table-sm">
                                            ...
                                            <tfoot>
                                                <tr id="totalRow" style="border: none">
                                                    ...
                                                    <td class="text-end bg-black text-white" style="font-weight: bold; border:none">{{ number_format($paymentDetail->total) }}</td>
                                        ...
                                        <div class="mt-6">
                                            <table class="text-center" style="width: auto; float:right;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{ asset('storage/' . $paymentDetail->createdBy->signature_url) }}" alt="Signature" width="100px" style="margin-bottom: 10px;">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="border-bottom: 1px solid black;">{{ $paymentDetail->createdBy->name }}</td>
                                                </tr>
                                                <tr>

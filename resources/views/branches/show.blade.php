                    ...
                    <div class="card-header shadow-sm p-3 d-flex justify-content-between align-items-center">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <form action="{{ route('branches.destroy', \App\Helpers\IdHashHelper::encode($branch->id)) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this branch?')" style="display:inline;">
                                    @csrf
                                    @method('DELETE')

                        ...
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">{{ $consignee->id }}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="{{ route('consignees.show', $consignee->id) }}">
                                                ...
                                                <a class="dropdown-item" href="{{ route('consignees.edit', $consignee->id) }}">
                                                ...
                                                <form action="{{ route('consignees.destroy',($consignee->id)) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this consignee?')" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')

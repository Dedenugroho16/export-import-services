                    ...
                    <div class="card-header shadow-sm p-3 d-flex justify-content-between align-items-center">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <form action="{{ route('consignees.destroy',($consignee->id)) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus consignee ini?')" style="display:inline;">
                                    @csrf
                                    @method('DELETE')

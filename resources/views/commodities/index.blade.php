        ...
        <div class="container-xl">
            ...
            @if (in_array(auth()->user()->role, ['admin', 'operator']))
                <div class="mb-4 align-items-center">
                    ...
                    <a href="{{ route('commodities.import') }}" class="btn btn-warning ms-3">
                            ...
                            @if (session('success') || session('exists') || session('failed'))
                                <script>
                                    ...
                                    if (failedData.length > 0) {
                                        let failedDetails = failedData.map(item => `${item.name} - Error: ${item.error}`).join('<br>');
        ...
        $(document).ready(function() {
            $('#commoditiesTable').DataTable({
                ...
                columnDefs: [{
                        width: '200px',
                        targets: 1
                    } // Set lebar kolom nama komoditas
                ],
                columns: [{
                        data: null,
                        class: 'text-center',

                    ...
                    <ul class="navbar-nav">
                        ...
                        @if (auth()->user()->role === 'admin')
                            ...
                            <li
                                ...
                                <div class="dropdown-menu {{ Request::is('proforma*') || Request::is('incomplete-invoice*') || Request::is('transaction*') ? 'show' : '' }}"
                                    ...
                                    <a class="dropdown-item {{ Request::is('transaction*') ? 'active-item' : '' }}"

                ...
                <div class="collapse navbar-collapse" id="sidebar-menu">
                    <ul class="navbar-nav">
                        ...
                        @if (in_array(auth()->user()->role, ['admin', 'operator', 'director', 'finance']))
                            ...
                            <li class="nav-item dropdown {{ Request::is('products*') || Request::is('detail-products*') ? 'show' : '' }}">
                                <a class="nav-link dropdown-toggle {{ Request::is('products*') || Request::is('detail-products*') ? 'active' : '' }}"
                                    href="#" id="productsDropdown" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="{{ Request::is('products*') || Request::is('detail-products*') ? 'true' : 'false' }}">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                                ...
                                <ul class="dropdown-menu {{ Request::is('products*') || Request::is('detail-products*') ? 'show' : '' }}" aria-labelledby="productsDropdown">
                                    <li>
                                        <a class="dropdown-item {{ Request::is('products*') ? 'active-item' : '' }}" href="{{ url('/products') }}">
                                            Produk
                                        </a>
                                    </li>
                                    <li>
